...
出力: articles/新宿駅のレンタルダンススタジオおすすめ.html  (--filename-mode ja, default)
      articles/shinjuku-station-rental-dance-studio.html  (--filename-mode slug)
"""
...
CANDIDATES_CSV   = "data/pipeline/debug_shinjuku_station_candidates.csv"
TARGET_GROUP_COUNT = 15

STATION_NAME  = "新宿駅"
STATION_FREE  = "新宿"
ARTICLE_TITLE = "新宿駅のレンタルダンススタジオおすすめ15選"
FILENAME_BASE = "新宿駅のレンタルダンススタジオおすすめ"
SLUG_NAME     = "shinjuku-station-rental-dance-studio"

RELATED_ARTICLES = [
    ("新宿のレンタルダンススタジオおすすめ", "新宿のレンタルダンススタジオおすすめ.html"),
    ("原宿駅のレンタルダンススタジオおすすめ", "原宿駅のレンタルダンススタジオおすすめ.html"),
    ("高田馬場駅のレンタルダンススタジオおすすめ", "高田馬場駅のレンタルダンススタジオおすすめ.html"),
    ("表参道駅のレンタルダンススタジオおすすめ", "表参道駅のレンタルダンススタジオおすすめ.html"),
    ("四ツ谷駅のレンタルダンススタジオおすすめ", "四ツ谷駅のレンタルダンススタジオおすすめ.html"),
    ("青山一丁目駅のレンタルダンススタジオおすすめ", "青山一丁目駅のレンタルダンススタジオおすすめ.html"),
    ("東中野駅のレンタルダンススタジオおすすめ", "東中野駅のレンタルダンススタジオおすすめ.html"),
    ("中野坂上駅のレンタルダンススタジオおすすめ", "中野坂上駅のレンタルダンススタジオおすすめ.html"),
...
# 新宿エリア別 説明文 (make_area_section用)
SHINJUKU_AREA_DESC: dict[str, str] = {
    "新宿駅":    "JR・私鉄・地下鉄が集まる新宿の中心。南口・東口・西口など出口が多いため、"
                 "スタジオ案内で「どの出口から何分」かを事前に確認するとスムーズです。",
    "西武新宿駅": "新宿駅から徒歩5〜10分。歌舞伎町に近く、西新宿7丁目エリアにスタジオが点在します。"
                  "深夜まで賑わうエリアのため、夜間練習後のアクセスも便利です。",
    "代々木駅":  "JR・都営大江戸線が乗り入れる代々木エリア。静かな住宅・オフィス街で、"
                 "ダンス・ヨガ系のスタジオが多く集まります。新宿駅からも徒歩圏内です。",
    "新大久保駅": "JR山手線の新大久保。K-POP文化の拠点としても知られ、"
                  "ダンス練習やK-POP曲の振付確認を目的とした利用者も多いエリアです。",
    "北参道駅":  "東京メトロ副都心線の北参道。千駄ケ谷・代々木公園方面で、"
                 "中規模〜大型のダンス・音楽スタジオが集まるエリアです。",
}
...
def _make_rich_fallback(g: Group) -> str:
    ...
    area_tags     = _get_area_tags(g.address, g.primary_station)
    has_kpop      = "K-POP練習候補" in area_tags
    has_kabuki    = "歌舞伎町エリア" in area_tags
    has_yoyogi    = "代々木方面" in area_tags
    has_kitasando = "北参道方面" in area_tags

    is_dance  = any(kw in name for kw in ["ダンス", "dance", "Dance", "だんすた", "Beat", "beat"])
    ...
    if total > 1:
        ...
        s1 = (
            "新大久保・百人町エリアに位置し、K-POPダンスの振付練習を目的とした"
            "利用者も多いエリアのスタジオ。"
        )
    elif has_kabuki:
        s1 = "新宿駅東口・歌舞伎町に近い立地で、仕事帰りや移動前後に立ち寄りやすいスタジオ。"
    elif has_yoyogi:
        s1 = "代々木方面に位置し、新宿・渋谷の両方向からアクセスしやすい立地のスタジオ。"
    elif has_kitasando:
        s1 = "千駄ケ谷・北参道エリアの落ち着いた環境にある、ダンス・音楽系スタジオが集まる立地。"
    ...
    if g.is_partner and not s2_mentions_partner:
        ...
        s3 = "K-POP・ストリート系の振付練習を新大久保方面で探しているなら候補に入れてほしいスタジオ。"
    elif has_kitasando:
        # 千駄ケ谷・北参道は新宿と渋谷の中間エリア。代々木公園の一文とは分ける
        st_label = g.primary_station or "千駄ケ谷・北参道"
        s3 = f"{st_label}エリアは、新宿・渋谷どちらからも行きやすく、リハーサルや撮影練習にも静かな環境が使いやすい。"
    elif has_yoyogi:
        # 代々木エリアは駅アクセス面で言及する。「代々木公園周辺の静かな環境で」の一文はここだけに限定
        if g.distance_m and g.distance_m <= 600:
            st_label = g.primary_station or "代々木駅"
            s3 = f"{st_label}から近く、じっくり練習したい日の定番候補として選びやすい。"
        else:
            s3 = "代々木エリアならではの落ち着いた雰囲気の中で、振付をしっかり固めたいときにおすすめ。"
...
def make_desc(g: Group) -> str:
    ...
    if total > 1:
        parts.append(
            f"新宿駅周辺に{total}店舗を展開するレンタルスタジオです。"
        )
    elif dist:
...
def make_intro(count: int) -> str:
    return (
        f"<p>新宿でスタジオを探すとき、「駅からすぐのところがいい」「鏡が大きくて床がしっかりしているスタジオがいい」"
        ...
        f"<p>新宿エリアは複数路線が乗り入れる交通の要所で、"
        f"歌舞伎町・西新宿・代々木・新大久保など、それぞれ雰囲気の異なるエリアにスタジオが点在しています。"
        f"集合場所や帰り道のルートに合わせて、自分に合ったスタジオを見つけてみてください。</p>"
    )
...
def make_selection_points() -> str:
    return (
        ...
        f"  <ul>\n"
        f"    <li><strong>駅からの距離と出口：</strong>新宿は出口が多いため、"
...
def make_area_section(groups: list[Group]) -> str:
    ...
    rows = []
    # SHINJUKU_AREA_DESC に記載された駅を優先 (件数の多い順)
    ordered_stations = sorted(
        station_counts.keys(),
        key=lambda s: (s not in SHINJUKU_AREA_DESC, -station_counts[s]),
    )
    for st in ordered_stations:
        cnt  = station_counts[st]
        desc = SHINJUKU_AREA_DESC.get(
            st,
    ...
    return (
        ...
        "  <h2>エリア・駅別の特徴</h2>\n"
        "  <p>新宿駅は多くの路線が交わる巨大ターミナルで、"
        "周辺エリアによって雰囲気や利用者層が異なります。"
    ...
    faqs = [
        {
            "q": "新宿駅と西武新宿駅は違うのですか？",
            "a": (
                "はい、別の駅です。新宿駅はJR・小田急・京王・東京メトロ・都営地下鉄が乗り入れる巨大ターミナル、"
                "西武新宿駅は西武新宿線の終着駅で、歌舞伎町の北側に位置します。"
                "徒歩で5〜10分ほど離れており、スタジオの案内に記載の駅を確認して向かいましょう。"
            ),
        },
        {
            "q": "K-POPの振付練習に向いているエリアはありますか？",
            "a": (
                "新大久保は韓国カルチャーの拠点として知られており、"
                "K-POPの振付練習を目的にスタジオを利用するダンサーも多いエリアです。"
                "今回の掲載スタジオではLANDstudio 新宿店（新大久保駅方面）が新大久保方面に位置しています。"
                "西武新宿駅周辺のスタジオも新大久保へのアクセスが比較的便利です。"
            ),
        },
        {
        ...
        },
        {
            ...
            "a": (
                "BUZZ レンタルスタジオ（複数店舗）、BEATs レンタルスタジオ ビーツ、"
                "Hina STUDIO（2店舗）、Studio-Bioはオンラインで空き状況を確認・予約できます。"
        ...
        },
        {
            ...
            "a": (
                ...
                "の5点を確認しておくと安心です。"
                "新宿は出口が複雑なため、案内に記載の出口番号も合わせて確認しておきましょう。"
            ),
        },
    ]
...
def main():
    parser = argparse.ArgumentParser(description="新宿駅ダンススタジオ記事生成")
    parser.add_argument(
        "--filename-mode",
        default="ja",
