...
# -*- coding: utf-8 -*-
"""
渋谷駅レンタルダンススタジオ記事生成 (Step 4 v3)
入力: data/pipeline/渋谷駅のレンタルダンススタジオおすすめ_selected_studios.csv
...
出力: articles/渋谷駅のレンタルダンススタジオおすすめ.html  (--filename-mode ja, default)
      articles/shibuya-station-rental-dance-studio.html  (--filename-mode slug)
"""
...
# 設定
# ============================================================
STATION_CSV  = "data/pipeline/渋谷駅のレンタルダンススタジオおすすめ_selected_studios.csv"
...
CANDIDATES_CSV   = "data/pipeline/渋谷駅のレンタルダンススタジオおすすめ_selection_score_debug.csv"
TARGET_GROUP_COUNT = 15

STATION_NAME  = "渋谷駅"
STATION_FREE  = "渋谷"
ARTICLE_TITLE = "渋谷駅のレンタルダンススタジオおすすめ15選"
FILENAME_BASE = "渋谷駅のレンタルダンススタジオおすすめ"
SLUG_NAME     = "shibuya-station-rental-dance-studio"

RELATED_ARTICLES = [
    ("渋谷のレンタルダンススタジオおすすめ", "渋谷のレンタルダンススタジオおすすめ.html"),
    ("六本木駅のレンタルダンススタジオおすすめ", "六本木駅のレンタルダンススタジオおすすめ.html"),
    ("代々木駅のレンタルダンススタジオおすすめ", "代々木駅のレンタルダンススタジオおすすめ.html"),
    ("青山一丁目駅のレンタルダンススタジオおすすめ", "青山一丁目駅のレンタルダンススタジオおすすめ.html"),
    ("品川駅のレンタルダンススタジオおすすめ", "品川駅のレンタルダンススタジオおすすめ.html"),
    ("新宿駅のレンタルダンススタジオおすすめ", "新宿駅のレンタルダンススタジオおすすめ.html"),
    ("五反田駅のレンタルダンススタジオおすすめ", "五反田駅のレンタルダンススタジオおすすめ.html"),
    ("目黒駅のレンタルダンススタジオおすすめ", "目黒駅のレンタルダンススタジオおすすめ.html"),
...
# 渋谷エリア別 説明文 (make_area_section用)
SHIBUYA_AREA_DESC: dict[str, str] = {
    "渋谷駅":   "JR・東急・東京メトロが集まる渋谷の中心。ハチ公口・東口・西口など出口が多いため、"
                "スタジオ案内に記載の出口を事前に確認してから向かうとスムーズです。",
    "神泉駅":   "東急田園都市線の神泉。渋谷駅から徒歩5分ほどで、道玄坂・円山町エリアに近い立地です。",
    "恵比寿駅": "JR・東京メトロの恵比寿。渋谷から一駅で、落ち着いた雰囲気の中にスタジオがあります。",
    "表参道駅": "東京メトロの表参道。渋谷駅から徒歩15分ほど、原宿・南青山エリアのスタジオです。",
}
...
def _make_rich_fallback(g: Group) -> str:
    ...
    area_tags     = _get_area_tags(g.address, g.primary_station)
    has_dogenzaka   = "道玄坂エリア" in area_tags
    has_center      = "渋谷中心部" in area_tags
    has_ebisu       = "恵比寿方面" in area_tags
    has_omotesando  = "表参道方面" in area_tags
    has_sakuragaoka = "桜丘エリア" in area_tags
    ...
    if total > 1:
        ...
        s1 = "原宿・表参道方面に位置し、南青山の落ち着いた環境でダンス練習に集中できるスタジオ。"
    elif has_ebisu:
        s1 = "恵比寿エリアの閑静な立地で、渋谷・代官山の両方からアクセスしやすいスタジオ。"
    elif has_dogenzaka:
        s1 = "道玄坂・円山町エリアに位置し、渋谷駅から徒歩圏内でアクセスしやすいスタジオ。"
    elif has_sakuragaoka:
        s1 = "渋谷駅桜丘口方面の静かなエリアにある、練習に集中しやすい環境のスタジオ。"
    ...
    if g.is_partner and not s2_mentions_partner:
        ...
        st_label = g.primary_station or "表参道"
        s3 = f"{st_label}エリアで振付やリハーサルに集中したい場合の候補。表参道・原宿方面からも行きやすい。"
    elif has_ebisu:
        s3 = "恵比寿方面で落ち着いた環境を求める場合、渋谷・代官山どちらからもアクセスできる点が使いやすい。"
...
def make_intro(count: int) -> str:
    return (
        f"<p>渋谷でスタジオを探すとき、「道玄坂周辺で使いやすいところがいい」「表参道・恵比寿方面もOK」"
        ...
        f"<p>渋谷エリアは道玄坂・神泉・恵比寿・表参道など、それぞれ個性の違うエリアにスタジオが点在しています。"
...
def make_selection_points() -> str:
    return (
        ...
        f"  <ul>\n"
        f"    <li><strong>駅からの距離と出口：</strong>渋谷は再開発で出口配置が変わっているため、"
        f"「どの出口から何分」かを公式サイトや案内で事前に確認しておくとスムーズです。</li>\n"
...
def make_area_section(groups: list[Group]) -> str:
    ...
    rows = []
    # SHIBUYA_AREA_DESC に記載された駅を優先 (件数の多い順)
    ordered_stations = sorted(
        station_counts.keys(),
        key=lambda s: (s not in SHIBUYA_AREA_DESC, -station_counts[s]),
    )
    for st in ordered_stations:
        cnt  = station_counts[st]
        desc = SHIBUYA_AREA_DESC.get(
            st,
    ...
    return (
        ...
        "  <h2>エリア・駅別の特徴</h2>\n"
        "  <p>渋谷駅周辺は道玄坂・神泉・恵比寿・表参道と多彩なエリアが広がり、"
        "それぞれ雰囲気や利用者層が異なります。"
...
def make_faq() -> tuple[str, list[dict]]:
    faqs = [
        {
            "q": "渋谷駅は出口が複雑ですが、スタジオに行くときのコツはありますか？",
            "a": (
                "渋谷駅は2019年以降に改装が続いており、出口の構成が変わっています。"
                "各スタジオの案内に記載された出口番号や最寄りバス停を確認してから向かうのがおすすめです。"
                "スタジオによっては「ハチ公口から徒歩〇分」など具体的な道順が案内されています。"
            ),
        },
        {
            "q": "表参道・恵比寿のスタジオも渋谷駅から使えますか？",
            "a": (
                "はい、表参道は渋谷駅から徒歩15〜20分、または地下鉄で1〜2駅です。"
                "恵比寿はJRで1駅（約3分）です。"
                "この記事では渋谷駅から1200m圏内のスタジオを掲載しているため、"
                "表参道・恵比寿エリアのスタジオも含まれています。"
            ),
        },
        {
            "q": f"{STATION_NAME}周辺でオンライン予約できるスタジオは？",
            "a": (
                "BUZZ レンタルスタジオ（渋谷PARK店・TOWER店・MARKCITY店）、"
                "レンタルスタジオAivic（渋谷道玄坂・恵比寿）、チェリッシュスタジオ各館、"
                "ザ・スペース大久保南口はオンラインで空き状況を確認・予約できます。"
            ),
        },
        {
            "q": "予約前に確認しておくべきことは？",
            "a": (
                ...
                "の5点を確認しておくと安心です。"
                "渋谷は再開発が続いているため、入口・アクセス経路が変わっていることがあります。"
                "事前に公式サイトやGoogleマップで場所を確認しておきましょう。"
            ),
        },
    ]
...
def main():
    parser = argparse.ArgumentParser(description="渋谷駅ダンススタジオ記事生成")
    parser.add_argument(
        "--filename-mode",
        default="ja",
